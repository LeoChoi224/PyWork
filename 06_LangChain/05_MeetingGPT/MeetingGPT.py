...
if video:
    ...
    with summary_tab:
        ...
        if start:
            ...
            # 첫번째 chain
            fisrt_summary_prompt = ChatPromptTemplate.from_template(
                """
            ...
            first_summary_chain = fisrt_summary_prompt | llm | StrOutputParser()
            ...
            with st.status("Summarizing...") as status:
                for i, doc in enumerate(docs[1:]):
                    summary = refine_chain.invoke({
                        "existing_summary": summary,   # 이전 summary
                        "context": doc.page_content,   # 이번 Document
                    })
