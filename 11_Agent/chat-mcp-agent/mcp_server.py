...
def get_news_headlines() -> str:
    ...
    for i, entry in enumerate(feed.entries, 1):
        title = getattr(entry, "title", "제목 없슴")
...
def get_kbo_rank() -> str:
    ...
    result = httpx.get(
        "https://sports.daum.net/prx/hermes/api/team/rank.json?leagueCode=kbo"  # 최신 season
    )
